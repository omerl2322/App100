...
public class Infastructure extends Activity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {

    private final String LOG_TAG = "TestApp";
    private Spinner InfSpinner; //event type
    ...
    private Connector connectorInf;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_infastructure);
        buildGoogleApiClient();
        connectorInf = new Connector();
        InfSpinner = (Spinner) findViewById(R.id.eventTypeSpinner);
        ArrayAdapter<String> SpinnerAdapter = new ArrayAdapter<String>
                (this, android.R.layout.simple_spinner_item,
                        getResources().getStringArray(R.array.OptionsInf));
        InfSpinner.setAdapter(SpinnerAdapter);
        ...
        goBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Infastructure.this,MainActivity.class);
        ...
        ////////////////////////////////////////////////////////////////////////////////
        connectorInf.databaseReferenceReport.child("Infastructure").addValueEventListener(new ValueEventListener() {
            @Override
        ...
        sendReport.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mProgressDialog = ProgressDialog.show(Infastructure.this,"אנא המתן","שולח דוח..",true);
                //mProgressDialog.setMessage("שולח דוח.."); //start dialog progress
                //mProgressDialog.show();
                //take data from form
                final String sogEvent = InfSpinner.getSelectedItem().toString();
                ...
                mDataBaseUser.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        reference=  connectorInf.databaseReferenceReport.child("Infastructure").push();

                        Report rProp = new Report(Long.toString(numberReport),sogEvent,rDate,rTime, tehorEvent, locationEvent,uId,idUser);

                        reference.setValue(rProp);

                        if(imageUri!=null) {
                            StorageReference filePath = connectorInf.mReportsPhotosStorageRef.child("Infastructure").
                        ...
                        if(imageUri2!=null) {
                            StorageReference filePath1 = connectorInf.mReportsPhotosStorageRef.child("Infastructure").
                        ...
                        if(bitmap!=null){
                            ...
                            StorageReference filePath2 = connectorInf.mReportsPhotosStorageRef.child("Infastructure").
                ...
                Intent i = new Intent(Infastructure.this,Instructions.class);
                startActivity(i);
                finish();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == GALLERY_REQUEST && resultCode == RESULT_OK) {
            if (choosen == 0) {
                ...
                Toast.makeText(Infastructure.this, "שים לב , לא ניתן להוסיף יותר מ2 תמונות", Toast.LENGTH_LONG).show();
                choosen = 0;
            }
    ...
    public Action getIndexApiAction() {
        Thing object = new Thing.Builder()
                .setName("Infastructure Page") // TODO: Define a title for the content shown.
