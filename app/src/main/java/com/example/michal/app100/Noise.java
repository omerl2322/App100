...
public class Noise extends Activity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {

    private final String LOG_TAG = "TestApp";
    private Spinner NoiseSpinner; //event type
    ...
    private Connector connectorNoise;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        connectorNoise = new Connector();
        NoiseSpinner = (Spinner) findViewById(R.id.eventTypeSpinner);
        ArrayAdapter<String> SpinnerAdapter = new ArrayAdapter<String>
                (this, android.R.layout.simple_spinner_item,
                        getResources().getStringArray(R.array.OptionsNoise));
        NoiseSpinner.setAdapter(SpinnerAdapter);
        ...
        goBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Noise.this,MainActivity.class);
        ...
        ////////////////////////////////////////////////////////////////////////////////
        connectorNoise.databaseReferenceReport.child("Noise").addValueEventListener(new ValueEventListener() {
            @Override
        ...
        sendReport.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mProgressDialog = ProgressDialog.show(Noise.this,"אנא המתן","שולח דוח..",true);
                //mProgressDialog.setMessage("שולח דוח.."); //start dialog progress
                //mProgressDialog.show();
                //take data from form
                final String sogEvent = NoiseSpinner.getSelectedItem().toString();
                ...
                mDataBaseUser.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        reference=  connectorNoise.databaseReferenceReport.child("Noise").push();
                        ...
                        if(imageUri!=null) {
                            StorageReference filePath = connectorNoise.mReportsPhotosStorageRef.child("Noise").
                        ...
                        if(imageUri2!=null) {
                            StorageReference filePath1 = connectorNoise.mReportsPhotosStorageRef.child("Noise").
                        ...
                        if(bitmap!=null){
                            ...
                            StorageReference filePath2 = connectorNoise.mReportsPhotosStorageRef.child("Noise").
                ...
                Intent i = new Intent(Noise.this,Instructions.class);
                startActivity(i);
                finish();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == GALLERY_REQUEST && resultCode == RESULT_OK) {
            if (choosen == 0) {
                ...
                Toast.makeText(Noise.this, "שים לב , לא ניתן להוסיף יותר מ2 תמונות", Toast.LENGTH_LONG).show();
                choosen = 0;
            }
    ...
    public Action getIndexApiAction() {
        Thing object = new Thing.Builder()
                .setName("Noise Page") // TODO: Define a title for the content shown.
