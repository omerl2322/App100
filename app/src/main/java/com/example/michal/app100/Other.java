...
public class Other extends Activity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
            ...
            private Connector connectorOther;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ////////////////////////////////////////////////////////////////////////////////
        connectorOther.databaseReferenceReport.child("Other").addValueEventListener(new ValueEventListener() {
            @Override
        ...
        sendReport.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mProgressDialog = ProgressDialog.show(Other.this,"אנא המתן","שולח דוח..",true);
                ...
                mDataBaseUser.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        reference = connectorOther.databaseReferenceReport.child("Other").push();

                        Report rProp = new Report(Long.toString(numberReport),rDate,rTime, tehorEvent, locationEvent,uId,idUser);

                        reference.setValue(rProp);

                        if(imageUri!=null) {
                            StorageReference filePath = connectorOther.mReportsPhotosStorageRef.child("Other").
                        ...
                        if(imageUri2!=null) {
                            StorageReference filePath1 = connectorOther.mReportsPhotosStorageRef.child("Other").
                        ...
                        if(bitmap!=null){
                            ...
                            StorageReference filePath2 = connectorOther.mReportsPhotosStorageRef.child("Other").
                ...
                Intent i = new Intent(Other.this,MainActivity.class);
                startActivity(i);
                finish();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == GALLERY_REQUEST && resultCode == RESULT_OK) {
            if (choosen == 0) {
                ...
                Toast.makeText(Other.this, "שים לב , לא ניתן להוסיף יותר מ2 תמונות", Toast.LENGTH_LONG).show();
                choosen = 0;
            }
