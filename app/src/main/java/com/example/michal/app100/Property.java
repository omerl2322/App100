...
public class Property extends Activity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    private final String LOG_TAG = "TestApp";
    private Spinner PropertySpinner; //event type
    ...
    private Connector connectorProperty;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        connectorProperty = new Connector();
        PropertySpinner = (Spinner) findViewById(R.id.eventTypeSpinner);
        ...
        ////////////////////////////////////////////////////////////////////////////////
        connectorProperty.databaseReferenceReport.child("Property").addValueEventListener(new ValueEventListener() {
            @Override
        ...
        sendReport.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mProgressDialog = ProgressDialog.show(Property.this,"אנא המתן","שולח דוח..",true);
                //mProgressDialog.setMessage("שולח דוח.."); //start dialog progress
                //mProgressDialog.show();
                //take data from form
                final String sogEvent = PropertySpinner.getSelectedItem().toString();
                ...
                mDataBaseUser.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        reference=  connectorProperty.databaseReferenceReport.child("Property").push();
                        ...
                        if(imageUri!=null) {
                            StorageReference filePath = connectorProperty.mReportsPhotosStorageRef.child("Property").
                        ...
                        if(imageUri2!=null) {
                            StorageReference filePath1 = connectorProperty.mReportsPhotosStorageRef.child("Property").
                        ...
                        if(bitmap!=null){
                            ...
                            StorageReference filePath2 = connectorProperty.mReportsPhotosStorageRef.child("Property").
                ...
                Intent i = new Intent(Property.this,Instructions.class);
                startActivity(i);
                finish();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == GALLERY_REQUEST && resultCode == RESULT_OK) {
            if (choosen == 0) {
                ...
                Toast.makeText(Property.this, "שים לב , לא ניתן להוסיף יותר מ2 תמונות", Toast.LENGTH_LONG).show();
                choosen = 0;
            }
    ...
    public Action getIndexApiAction() {
        Thing object = new Thing.Builder()
                .setName("Property Page") // TODO: Define a title for the content shown.
